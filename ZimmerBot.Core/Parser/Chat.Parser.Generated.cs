...
// UserName: Jorn
// Input file <Parser\Chat.Language.grammar.y - 13-03-2016 12:10:33>
...
{
internal enum Token {error=2,EOF=3,T_NUMBER=4,T_WORD=5};
...
#pragma warning disable 162, 1522
    ...
    {
      case 2: // main -> itemSeq
{ Result = ValueStack[ValueStack.Depth-1].ts; CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
        break;
      case 3: // itemSeq -> itemSeq, item
{ ValueStack[ValueStack.Depth-2].ts.Add(ValueStack[ValueStack.Depth-1].t); CurrentSemanticValue = ValueStack[ValueStack.Depth-2]; }
        break;
      case 4: // itemSeq -> /* empty */
{ CurrentSemanticValue.ts = new ZTokenString(); }
        break;
      case 5: // item -> T_NUMBER
