...
// UserName: Jorn
// Input file <TemplateParser\Template.Language.grammar.y - 27-03-2016 21:13:47>
...
#pragma warning restore 649
  ...
  static TemplateParser() {
    ...
    states[3] = new State(new int[]{4,5,6,6,5,7,3,-2},new int[]{-4,4});
    states[4] = new State(-3);
    states[5] = new State(-5);
    states[6] = new State(-6);
    states[7] = new State(-4,new int[]{-3,8});
    states[8] = new State(new int[]{6,9,4,5,5,7},new int[]{-4,4});
    states[9] = new State(new int[]{4,-6,6,-6,5,-6,3,-7});
    ...
    rules[7] = new Rule(-4, new int[]{5,-3,6});
  }
...
{ CurrentSemanticValue.token = new TextTemplateToken(ValueStack[ValueStack.Depth-1].s); }
        break;
      case 6: // token -> T_RTAG
{ CurrentSemanticValue.token = new TextTemplateToken("}"); }
        break;
      case 7: // token -> T_LTAG, tokenSeq, T_RTAG
