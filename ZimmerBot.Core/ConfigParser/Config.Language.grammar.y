...
internalStatement
  ...
  | T_STARTTOPIC T_WORD     { $$.statement = new StartTopicStatement($2.s, false); }
  | T_RESTARTTOPIC T_WORD   { $$.statement = new StartTopicStatement($2.s, true); }
...
patternExpr
  ...
  | wildcardPatternExpr { $$.patternExpr = $1.patternExpr; }
